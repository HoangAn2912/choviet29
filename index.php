...
<?php
session_start();
$baseUrl = 'http://' . $_SERVER['HTTP_HOST'] . '/project/'; // bạn có thể thay đổi cho phù hợp
?>
    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse show position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <?php if (isset($_SESSION['user_id'])): ?>
                                        <a class="dropdown-item" href="<?php echo $baseUrl; ?>frontend/view/profile/index.php">Quản lý thông tin</a>
                                        <a class="dropdown-item" href="<?php echo $baseUrl; ?>frontend/controller/cLoginLogout.php?action=logout">Đăng xuất</a>
                                    <?php else: ?>
                                        <a class="dropdown-item" href="<?php echo $baseUrl; ?>frontend/loginlogout/login.php">Đăng nhập</a>
                                    <?php endif; ?>
                                </div>
                            </div>
